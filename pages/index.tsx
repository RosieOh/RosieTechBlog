  ...
  return (
    <>
      ...
      <section className="my-10">
        <h1 className="font-bold text-2xl sm:text-4xl font-mono">🧑🏻‍💻 RosieOh</h1>
      </section>
      <section className="flex justify-center gap-8 items-center flex-wrap">
        ...
        <div className="min-w-[250] max-w-[300px]">
          <h2 className="font-bold text-xl">기록하는 개발자 오태훈 입니다.</h2>
          <br />
          <p>얻은 지식을 프로젝트에 적용시키려 노력합니다.</p>
          <p>기록하는 습관을 통해 배운 것을 기록하려고 노력합니다.</p>
